...
out_dir = osp.join('./work_dirs/checkpoints', timestamp)
default_hooks = dict(
...
val_evaluator = dict(
    ...
    ann_file='./data/OdinMJ-coco/annotations/val.json',
    metric='bbox')

test_evaluator = dict(
    type='mmdet.CocoMetric',
    proposal_nums=(100, 1, 10),
    ann_file='./data/OdinMJ-coco/annotations/val.json',                               # '../OdinMJ-coco/annotations/test.json'
    metric='bbox')
...
launcher = 'none'
work_dir = './work_dirs/bi_yolov5-OdinMj-coco'
